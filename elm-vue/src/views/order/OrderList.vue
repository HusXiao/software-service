...
export default {
  ...
  created() {
    ...
    this.$axios.get('/OrdersController/listOrdersByUserId/' + this.user.userId).then(response => {
    ...
    this.user = this.$getSessionStorage('user');
    this.$axios.get('/OrdersController/getOrdersById/' + this.orderId).then(response => {
