	...
	export default {
		...
		methods: {
			listDeliveryAddressByUserId() {
				...
				//             })).then(response=>{
				this.$axios.get('DeliveryAddressController/listDeliveryAddressByUserId/'+this.user.userId).then(response => {
			...
			removeUserAddress(daId) {
				...
				// 	daId: daId
				// })).then(response => {
				this.$axios.delete('DeliveryAddressController/removeDeliveryAddress/'+daId).then(response => {
