...
export default {
  ...
  created() {
    ...
    //              daId:this.daId
    //          })).then(response => {
    this.$axios.get('DeliveryAddressController/getDeliveryAddressById/'+this.daId).then(response => {
  ...
  methods: {
    editUserAddress() {
      ...
      // 	)).then(response => {
      // 参数？？？！！！
      this.$axios.put('DeliveryAddressController/updateDeliveryAddress/'+this.deliveryAddress.daId+'/'+this.deliveryAddress.contactName+'/'
      +this.deliveryAddress.contactSex+'/'+this.deliveryAddress.contactTel+'/'+encodeURI(this.deliveryAddress.address)).then(response => {
